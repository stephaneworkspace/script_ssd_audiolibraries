...
# ----------------------------
# Librairies classiques (Application Support)
# ----------------------------
libs=(
  "Avid"                                                     # 10 go                      
...
# ----------------------------
# Dossiers dans l'utilisateur (ex: Spectrasonics)
# ----------------------------
user_libs=(
  "/Users/stephane/Library/Application Support/Spectrasonics" # 61 go
)
...
# ----------------------------
# Déplace les dossiers utilisateur et crée le symlink
# ----------------------------
for SRC in "${user_libs[@]}"; do
  lib_name=$(basename "$SRC")
  DEST_LIB="$DEST/UserLibs/$lib_name"   # sous-dossier "UserLibs" sur le SSD

  # Crée le dossier parent si inexistant
